        ...
        $.ajax(finalActionURL, {
            ...
            .done((res) => {
                ...
                if (formId === "wf-form-Query-Vector" && res[0]) {
                    document.getElementById("reset-button-div").contentTableDiv.style.display = "block";
                    reloadVectorData(res[0]);
                } else {
                    document.getElementById("reset-button-div").contentTableDiv.style.display = "none";
                    reloadAllData();
                }
